...
window.addEventListener("load", function(){
	...
	var ele2 = document.getElementById("result");
	var db = window.indexdDB || window.webkitIndexedDB || window.mozIndexedDB;
	if(db)
	{
		ele2.innerHTML = "Indexed Databaseは使用できます";
	}
	else
	{
		ele2.innerHTML = "Indexed Databaseは使用できません";
	}
}, true);