window.addEventListener("load", function(){
	// a要素を読み出し
	var tSwitch = document.getElementById("toggleSwitch");	// ●●S
	// a要素にイベントを割り当て
	tSwitch.addEventListener("click", function(){
		var tbl = document.querySelectorAll("table");	// ●●S
	...
	bannerImage.onload = function(){
		var aDiv = document.querySelectorAll("aside div")[0]; // ●●E
